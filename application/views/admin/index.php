...
<div class="container-fluid">
    ...
    <div class="row">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h1 mb-0 font-weight-bold text-white"><?= $this->ModelUser->getUserWhere(['role_id' => 1])->num)rows();?></div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h1 mb-0 font-weight-bold text-white">
                                <?php
                                $where = ['stock != 0'];
                                $totalstock = $this->ModelBuku->total('stok', $where);
                                echo $totalstock;
                                ?>
                            </div>
                        </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-succerss shadow h-100 py-2 bg-danger">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h1 mb-0 font-weight-bold text-white">
                                <?php 
                                $where = ['dipinjam != 0'];
                                $totalpinjam = $this->ModelBuku->total('dipinjam', $where);
                                echo $totaldipinjam;
                                ?>
                            </div>
                        </div>
        ...
        <div class="col-xl-3 xol-md-6 mb-4">
            <div class="card border-left-warning shadow h-100 py-2 bg-success">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col_auto">
                            <a href="<?= base_url('user'); ?>"><i class="fas fa-shopping-cart fa-3x text-danger"></a>
                        </div>
                    </div>
                </div>
            </div>
